...
const crearCategoria_1 = require("./crearCategoria");
...
class CategoriasController {
    constructor() {
        ...
        this.router.post("/crearCategoria", crearCategoria_1.nuevaCategoriaFotosHandler, crearCategoria_1.crearCategoriaHanler);
