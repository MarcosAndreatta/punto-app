...
const crearProducto_1 = require("./crearProducto");
...
class ProductosController {
    constructor() {
        ...
        this.router.post("/crearProducto", crearProducto_1.nuevoProductoFotosHandler, crearProducto_1.crearProductoHandler);
